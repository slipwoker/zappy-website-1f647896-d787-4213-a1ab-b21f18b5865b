document.addEventListener('DOMContentLoaded', function() {
  ...
  const animateElements = document.querySelectorAll('.fade-in, [data-animate]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ד.י פרוייקטים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1f647896-d787-4213-a1ab-b21f18b5865b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1f647896-d787-4213-a1ab-b21f18b5865b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1f647896-d787-4213-a1ab-b21f18b5865b';
